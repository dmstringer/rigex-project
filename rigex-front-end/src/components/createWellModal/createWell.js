...
export default function CreateWellModal({wellModalOpen, handleWellModalClose, rigId}) {
    ...
    const handleSubmit = async (event) => {
        ...
        // check state for no errors, then close modal or reset wellInfo
    ...
    const handleChange = (event) => {
        ...
        // prevent typing non-integer values or decimal into non-name fields
        ...
        <Dialog onClose={handleWellModalClose} aria-labelledby="customized-dialog-title" open={wellModalOpen}>
            <div className="modal-container">
                <div className="dialog-title">
                    Create well
                    <button aria-label="close" className="" onClick={handleWellModalClose}>
                        <CloseIcon />
                    </button>
                </div>
